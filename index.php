...
<body>
    ...
    <div class="container">
        <div class="tab">
            <button class="tablink active" onclick="openTab(event,'signin')" id="link1">Авторизироваться</button>
            <button class="tablink" onclick="openTab(event,'signup')" id="link2">Зарегистрироваться</button>
        </div>
        <div class="content">
            <div class="tabcontent" id="signin">
                <form method="post" onsubmit="return validateLogin()">
                    ...
                    <div class="required"></div>
                    <br><br>
                    <input type="submit" value="Логин" name="login">
                </form>
            </div>
            <div class="tabcontent" id="signup">
                <form method="post" onsubmit="return validateRegister()">
                    <!--Package One-->
                    <h2>Крайне необходимая информация</h2>
                    <hr>
                    <!--First Name-->
                    ...
                    <br>
                    <!--Confirm Password-->
                    <label>Подтвердить Пароль<span>*</span></label><br>
